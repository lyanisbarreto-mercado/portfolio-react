...
const ProjectList = [
        {
           ...
           summary: "In our User-Centered Design class, my groupmates and I tackled the issues we noticed in Public Transit applications. As a stepping stone for brand new users of the system, we addressed the confusion behind navigation and designed a solution for them.",
           image: RayExpressLogo ,
           url: "https://lnkd.in/exTMiFRG",
           why: "Our class was charged with creating an idea we wished to develop into an application. This involved planning and iterating through multiple prototypes. One noted the issue we had with public transportation — many people who had never ridden it before were completely unsure what to do. And some applications don’t make the process clear or trip planning easy. And so we came together in order to develop Ray Express, which addresses the issue including lack of information, unclear payment methods, and ",
